...
tags = {
   ...
   layout = { layouts[1], layouts[2], layouts[3], layouts[1], layouts[4],layouts[2], layouts[2], layouts[2], layouts[2] }
}
...
for s = 1, screen.count() do
    ...
    mylayoutbox[s]:buttons(awful.util.table.join(
                            ...
                            awful.button({ }, 7, function () awful.layout.inc(layouts, 1) end),
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn(text_editor) end),
